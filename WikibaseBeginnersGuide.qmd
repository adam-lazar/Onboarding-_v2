...
![](png/wikibase/taylorSwift_q26876_exampleItemDiagram.png)

::: callout-note
In this illustration we see the item *Q26876* from Wikidata[^wikibasebeginnersguide-3]. This item has the *label* Taylor Swift and the description *American singer-songwriter (born 1989)*. As we move on with the concepts later in this guide, this image will be referred as an example.
:::

[^wikibasebeginnersguide-3]: <https://www.wikidata.org/wiki/Q26876>
...
![](png/wikibase/blankProperty.png)
...
Let us consider the most ubiquitous property in Wikibase: *instance of* (P31)[^wikibasebeginnersguide-4].

[^wikibasebeginnersguide-4]: <https://www.wikidata.org/wiki/Property:P31>

![](png/wikibase/propertyP31_instanceOf.png)
...
If we visit our [Sandbox](https://reprexbase.eu/sandbox/index.php?title=Main_Page)

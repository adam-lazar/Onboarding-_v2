...
4. Check now your email inbox, you should recieve an email with a confirmation link. Click on this confirmation link. 

![](png/wikibase/request-account_confirmation-email.png)

5. After you confir your account request, the admins will evaluate it. Then you will receive another email with your login credentials, including your temporary password. 

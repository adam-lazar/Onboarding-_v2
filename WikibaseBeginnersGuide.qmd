...
3. On the next page type in your chosen **username** and your **email address**. For a username use a professional one, similar to what you use on Keybase, Github, etc. Then confirm by clicking **request account** again. 

![](png/wikibase/request-account_2.png)

4. Check now your email inbox, you should receive an email with a confirmation link. Click on this confirmation link. 

![](png/wikibase/request-account_confirmation-email.png)

5. After you confirm your account request, the admins will evaluate it. Then you will receive another email with your login credentials, including your temporary password. 
![](png/wikibase/request-account_email-with-temporary-login-credentials.png)

6. Visit the sandbox page again and log in. On the login page type your username and the temporary password you received, then click **Log In**. It will take you automatically to the next page, where you have to change your password by typing your new permanent password. Provide your new password then confirm it. 

![](png/wikibase/request-account_log-in-page.png)

7. All done, you are now logged in to your personal account.
